...
if ( $isgout == 0 )  { die "Given file $goutfile is NOT gaussian output file.\n Please check.\n";}
...
sub help {
	system("perldoc /home/lfqcomputacional/Desktop/eduardo/git/github-tao/taopackage/taopackage/scripts/parmlookup.pl");
	exit;
}
